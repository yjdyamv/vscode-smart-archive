/**
 * File-type icons — Smart Archive VSCode Extension
 *
 * Provides color-coded emoji icons for file entries in the archive
 * browser tree, matched by file extension.
 *
 * @module providers/fileIcons
 */
