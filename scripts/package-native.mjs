#!/usr/bin/env node
/**
 * Package the full (native) build of the extension — Smart Archiver
 *
 * Produces smart-archiver-<version>-native.vsix with every engine
...
const out = path.join(root, `smart-archiver-${pkg.version}-native.vsix`);
